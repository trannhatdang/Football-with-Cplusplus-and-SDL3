...
Animation::Animation(SDL_Renderer* renderer, const std::string& filepath, int width, int height, int num_frames, int scale) : m_width(width), m_height(height), m_num_frames(num_frames), m_scale(scale)
{
